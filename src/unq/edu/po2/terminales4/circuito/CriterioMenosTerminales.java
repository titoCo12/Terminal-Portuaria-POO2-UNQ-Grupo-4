...
public class CriterioMenosTerminales implements CriterioCircuito {

	public Optional<Circuito> mejorCircuito(List<Circuito> circuitos, Puerto origen, Puerto destino) {
		return circuitos.stream().min(Comparator.comparing(c -> c.cantidadTerminalesEntre(origen,destino)));  
	}
